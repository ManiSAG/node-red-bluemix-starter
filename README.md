...
[![Deploy to Bluemix](https://bluemix.net/deploy/button.png)](https://bluemix.net/deploy?repository=https://github.com/watson-developer-cloud/node-red-bluemix-starter.git) [![Greenkeeper badge](https://badges.greenkeeper.io/watson-developer-cloud/node-red-bluemix-starter.svg)](https://greenkeeper.io/)
